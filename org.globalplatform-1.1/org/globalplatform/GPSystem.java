...
public class GPSystem
{
    ...
    * <li><em>This method may be implmented using a similar mechanism as described for the <code>getCVM</code> method.</em>
    * </ul>
    * <p>
    ...
    * </ul>
    * <p>
    * @param baBuffer the source byte array containing the ATR historical bytes. Must be a global array.
    ...
    * are set.
    * <p>Notes:<ul>
    * <li><em>The OPEN shall reject any transition request to the Life Cycle State INSTALLED</em>
    * <li><em>The OPEN shall reject any transition request to the Life Cycle State LOCKED.</em>
    * <li><em>The OPEN locates the entry of the current applet context in the GlobalPlatform Registry
    * and modifies the value of the Life Cycle State.</em>
    * </ul>
    * <p>
    * @param bState the application specific state.
    * @return true if the operation is successful, <code>false</code> otherwise.
    ...
    * @see <code>AID</code>
    * @see <code>GLOBAL_SERVICE_IDENTIFIER</code>, <code>FAMILY_CVM</code>, <code>FAMILY_SECURE_CHANNEL</code>, <code>FAMILY_USSM</code>
    */
