...
public interface SecureChannel extends Shareable
{
    ...
    * </ul>
    * <p>
    * @param baBuffer the source of the data to be wrapped. This buffer must be global.
    ...
    * </ul>
    * <p>
    * @param baBuffer the source of the data to be unwrapped. This buffer must be global.
    * @param sOffset the offset within <code>baBuffer</code> of the data to unwrap.
    * @param sLength the length of the data to unwrap.
    ...
    * </ul>
    * <p>
    * @param baBuffer the source byte array. This buffer must be global..
    ...
    * </ul>
    * <p>
    * @param baBuffer the byte array containing the data to be processed. This buffer must be global.
